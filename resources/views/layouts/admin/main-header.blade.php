									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6>{{\Illuminate\Support\Facades\Auth::user()->name}}</h6><span>{{\Illuminate\Support\Facades\Auth::user()->type}}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{auth()->user()->type=="admin" ? route('admin.profile') : route('user.profile')}}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i> Edit Profile</a>
									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>
									<a class="dropdown-item" href="{{route('admin.setting.show')}}"><i class="bx bx-slider-alt"></i> Site Settings</a>
